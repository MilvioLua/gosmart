...
if ( isset( $_POST[ 'email' ] ) && strlen( $_POST[ 'email' ] ) > 1 ) {
    ...
    try {
        ...
        $response = $cc->getContactByEmail( ACCESS_TOKEN, sanitize_text_field( $_POST[ 'email' ] ) );
        ...
        if (empty($response->results)) {
            ...
            $contact = new Contact();
            $contact->addEmail( sanitize_text_field( $_POST['email'] ) );
            $contact->addList( sanitize_text_field( $_POST['list'] ) );
