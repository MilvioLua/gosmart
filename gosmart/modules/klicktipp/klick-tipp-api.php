 ...
 * @version 2.1
 * 
 * A class providing a connection with the Klick-tipp REST server.
 */
...
class KlicktippConnector {
  ...
  /**
   * Instantiates an KlicktippConnector
   ...
   * Get last error
   * 
   * @return an error description of the last error
   */
  ...
  */
   ...
   * 
   * @param mixed $email The email address of the subscriber.
   * @param mixed $tagid The id of the manual tag the subscriber will be tagged with.
   * 
   * @return An object representing the Klicktipp subscriber object.
   */
  public function tag($email, $tagid) {
  ...
  */
   ...
   * @return TRUE on success
   */
  public function subscriber_update($subscriberid, $fields = array(), $newemail = '') {
   ...
   */
  public function signin($apikey, $email, $fields = array()) {
